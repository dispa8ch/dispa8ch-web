...
const pickObj = <T,U>(bool: any, first: T, second: U) => Boolean(bool) ? first : second;
...
const MobileLinks = ({ icon: Icon, name, to, sublinks }: MenuLink) => {
  ...
  return (
        ...
        <div className="w-full h-fit column gap-3 ">
          ...
          {sublinks && (
            <div className={`w-full space-y-4 bg-white/20 backdrop-blur-xl rounded-2xl dropdown-menu ${open && 'shown'} `}>
