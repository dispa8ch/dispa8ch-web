...
const WaitlistInput = (props?: WaitlistInputProps) => {
  return (
    <div className="w-full h-12 pl-4 pr-2 flex items-center justify-between border border-dispa8chRed-100 text-sm rounded-full" >
      <input className="w-3/4 border-none font-Inter p-0 focus:outline-none bg-transparent placeholder:text-dispa8chGray-100 lg:w-fit lg:flex-grow" placeholder="Enter your email address" />
