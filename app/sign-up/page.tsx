...
export default function SignUp() {
  ...
  return (
    <main className='w-screen min-h-screen px-4 bg-gradient-to-br from-[#D1193E1A] to-[#FDA8001A] font-Circular_Medium flex flex-col items-center justify-center gap-7 md:py-4 md:px-0'>
